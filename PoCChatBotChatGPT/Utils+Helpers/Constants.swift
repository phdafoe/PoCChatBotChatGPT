...
struct Constants {
    ...
    struct OpenAI {
        static let openAIKey: [UInt8] = [55, 30, 64, 92, 17, 120, 13, 39, 15, 42, 32, 4, 19, 32, 2, 7, 17, 30, 17, 89, 56, 47, 18, 59, 88, 39, 34, 49, 36, 36, 32, 48, 41, 68, 41, 71, 5, 29, 35, 18, 55, 18, 40, 7, 55, 26, 53, 34, 61, 45, 37]
        static let url: [UInt8] = [44, 1, 25, 29, 10, 112, 64, 68, 4, 62, 58, 97, 13, 26, 0, 13, 21, 45, 91, 14, 2, 20, 101, 25, 90, 74, 45, 60, 34, 18, 6, 0, 23, 29, 43, 27, 30]
